...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'fr_projet.save' => 'getFrProjet_SaveService',
            ...
            'frprojetbundle.locale_listener' => 'getFrprojetbundle_LocaleListenerService',
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addSubscriberService('frprojetbundle.locale_listener', 'Fr\\ProjetBundle\\EventListener\\LocaleListener');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony', 'user' => 'root', 'password' => 'okidoc', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Fr/ProjetBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Fr/UserBundle/Entity'), 2 => ($this->targetDirs[3].'/src/Fr/TicketsBundle/Entity'), 3 => ($this->targetDirs[3].'/src/Fr/ReponseBundle/Entity'), 4 => ($this->targetDirs[3].'/src/Fr/ForumBundle/Entity'), 5 => ($this->targetDirs[3].'/src/Fr/LogBundle/Entity'), 6 => ($this->targetDirs[3].'/src/Fr/LdapBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Fr\\ProjetBundle\\Entity');
        $c->addDriver($b, 'Fr\\UserBundle\\Entity');
        $c->addDriver($b, 'Fr\\TicketsBundle\\Entity');
        $c->addDriver($b, 'Fr\\ReponseBundle\\Entity');
        $c->addDriver($b, 'Fr\\ForumBundle\\Entity');
        $c->addDriver($b, 'Fr\\LogBundle\\Entity');
        $c->addDriver($b, 'Fr\\LdapBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('FrProjetBundle' => 'Fr\\ProjetBundle\\Entity', 'FrUserBundle' => 'Fr\\UserBundle\\Entity', 'FrTicketsBundle' => 'Fr\\TicketsBundle\\Entity', 'FrReponseBundle' => 'Fr\\ReponseBundle\\Entity', 'FrForumBundle' => 'Fr\\ForumBundle\\Entity', 'FrLogBundle' => 'Fr\\LogBundle\\Entity', 'FrLdapBundle' => 'Fr\\LdapBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_407dcb5c35137ac0f1a90350b048e023f4dca1f2574fd93088ec20ff9844380c');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Fr\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\Mailer($this->get('swiftmailer.mailer.default'), $this->get('router'), $this->get('templating'), array('confirmation.template' => 'email/register_check.email.twig', 'resetting.template' => 'FOSUserBundle:Resetting:email.txt.twig', 'from_email' => array('confirmation' => array('frprojetbundle@gmail.com' => 'Demo Registration'), 'resetting' => array('webmaster@example.com' => 'webmaster'))));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Fr\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Fr\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Fr\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Fr\\UserBundle\\Entity\\User');
    }
    ...
    /**
     * Gets the 'fr_projet.save' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Fr\ProjetBundle\Save\FrSave A Fr\ProjetBundle\Save\FrSave instance.
     * 
     * @throws InactiveScopeException when the 'fr_projet.save' service is requested while the 'request' scope is not active
     */
    protected function getFrProjet_SaveService()
    {
        if (!isset($this->scopedServices['request'])) {
            throw new InactiveScopeException('fr_projet.save', 'request');
        }

        return $this->services['fr_projet.save'] = $this->scopedServices['request']['fr_projet.save'] = new \Fr\ProjetBundle\Save\FrSave($this->get('doctrine.orm.default_entity_manager'), $this->get('request'));
    }
    ...
    /**
     * Gets the 'frprojetbundle.locale_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Fr\ProjetBundle\EventListener\LocaleListener A Fr\ProjetBundle\EventListener\LocaleListener instance.
     */
    protected function getFrprojetbundle_LocaleListenerService()
    {
        return $this->services['frprojetbundle.locale_listener'] = new \Fr\ProjetBundle\EventListener\LocaleListener('en');
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Fr\\UserBundle\\entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $k = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $i, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($i, '/fr/home'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => 'fos_user_security_logout'));
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('frprojetbundle@gmail.com');
        $a->setPassword('qsdfghjk');
        $a->setAuthMode('login');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Fr/ProjetBundle/Resources/views'), 'FrProjet');
        $instance->addPath(($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'/src/Fr/UserBundle/Resources/views'), 'FrUser');
        $instance->addPath(($this->targetDirs[3].'/src/Fr/TicketsBundle/Resources/views'), 'FrTickets');
        $instance->addPath(($this->targetDirs[3].'/src/Fr/ReponseBundle/Resources/views'), 'FrReponse');
        $instance->addPath(($this->targetDirs[3].'/src/Fr/ForumBundle/Resources/views'), 'FrForum');
        $instance->addPath(($this->targetDirs[3].'/src/Fr/LogBundle/Resources/views'), 'FrLog');
        $instance->addPath(($this->targetDirs[3].'/src/Fr/LdapBundle/Resources/views'), 'FrLdap');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'FrProjetBundle' => 'Fr\\ProjetBundle\\FrProjetBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'FrUserBundle' => 'Fr\\UserBundle\\FrUserBundle',
                'FrTicketsBundle' => 'Fr\\TicketsBundle\\FrTicketsBundle',
                'FrReponseBundle' => 'Fr\\ReponseBundle\\FrReponseBundle',
                'FrForumBundle' => 'Fr\\ForumBundle\\FrForumBundle',
                'FrLogBundle' => 'Fr\\LogBundle\\FrLogBundle',
                'FrLdapBundle' => 'Fr\\LdapBundle\\FrLdapBundle',
            ...
            'database_user' => 'root',
            'database_password' => 'okidoc',
            'mailer_transport' => 'gmail',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => 'frprojetbundle@gmail.com',
            'mailer_password' => 'qsdfghjk',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'frprojetbundle@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'qsdfghjk',
            ...
            'assetic.ruby.bin' => '/nfs/zfs-student-3/users/aollivie/goinfre/ruby/bin/ruby',
            ...
            'fos_user.registration.confirmation.template' => 'email/register_check.email.twig',
            'fos_user.storage' => 'orm',
            'fos_user.firewall_name' => 'main',
            'fos_user.model_manager_name' => NULL,
            'fos_user.model.user.class' => 'Fr\\UserBundle\\Entity\\User',
            ...
            'fos_user.registration.confirmation.from_email' => array(
                'frprojetbundle@gmail.com' => 'Demo Registration',
            ),
