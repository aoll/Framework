...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // fr_ldap_default_index
        if (0 === strpos($pathinfo, '/hello') && preg_match('#^/hello/(?P<name>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'fr_ldap_default_index')), array (  '_controller' => 'Fr\\LdapBundle\\Controller\\DefaultController::indexAction',));
        }

        // fr_projet_ldap_login
        if ($pathinfo === '/login_ldap') {
            return array (  '_controller' => 'Fr\\LdapBundle\\Controller\\LdapController::loginAction',  '_route' => 'fr_projet_ldap_login',);
        }
